...
| 4   | `scripts/check-theme-tokens.mjs` | Theme-contract check on `src/styles/tokens.css`                                                                 | A theme block missing a token override, or overriding a token that isn't in the contract |
