 ...
 * ContentFooterActions slots itself inline-end via its own CSS. Inside an
 * AppShell, pass the composed bar to the shell's `contentFooter` prop so it
 * pins below the scroll region. A plain <div>, not <footer> — the shell's
