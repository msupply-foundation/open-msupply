...
// not resolve to a store. A blocking Dialog (not dismissable — there is no store
// behind it to fall back to; picking one is the only way forward) hosting the shared
// StoreSelector panel (search + list with Default / Last-used chips + Continue). The
// caller has already ordered default/previous to the top and names them so the chips
// show.
