...
// TanStack and resize handles work in px; these bridge that boundary.
// (rootFontSizePx is also the basis for future virtualisation row-height math.)

/**
 * The current root font-size in px (what `1rem` currently equals). Reads the
 * live value.
 */
