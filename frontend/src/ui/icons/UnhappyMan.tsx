import styles from './UnhappyMan.module.css';

/*
 * The 404 page's illustration — the current app's UnhappyMan (a lost figure
 * on a cratered moon, planting a flag), ported verbatim from its
 * icons/UnhappyMan.tsx (issue #867: the rewrite's not-found page lost the
 * whimsy of the current one).
 *
 * Not in the icons barrel (`./index`) on purpose: it's an illustration, not a
 * 1em/currentColor glyph, and at ~3 KB gzip it must not ride into the main
 * bundle with the barrel — its only consumer (EntryPage's not-found variant)
 * loads it through `lazy()`, so it ships as its own chunk fetched when a 404
 * actually renders. Default export because that's the shape `lazy()` wants.
 *
 * Like the MSupplyGuyLogo brand gradient (see ./index), the illustration keeps
 * its own fixed palette rather than theme tokens — soft greys that read as
 * moonlight on both light and dark surfaces. It grows in on mount the way the
 * current app's does (MUI <Grow> over 1s), via --motion-grow, which the
 * tokens.css reduce block zeroes.
 */
const UnhappyMan = () => (
  <svg
  ...
  >
    <defs>
      ...
      >
        ...
        <stop stop-color="#D0D6DC" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="31.432%"
        y1="42.349%"
      ...
      >
        ...
        <stop stop-color="#D9DFE3" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="25.16%"
        y1="3.067%"
      ...
      >
        ...
        <stop stop-color="#E1E7EA" offset="71.754%" />
        <stop stop-color="#BCC3CA" offset="100%" />
      </linearGradient>
      <linearGradient x1="29.489%" y1="50%" x2="100%" y2="50%" id="oms-lost-h">
        <stop stop-color="#BAC6D2" offset="0%" />
        <stop stop-color="#7F8F9F" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="50%"
        y1="50%"
      ...
      <linearGradient
        ...
        id="oms-lost-j"
      >
        <stop stop-color="#DAE2E6" offset="0%" />
        <stop stop-color="#E3EBEF" offset="58%" />
        <stop stop-color="#EDF6F9" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="29.814%"
        y1="47.36%"
        ...
        id="oms-lost-k"
      >
        <stop stop-color="#C4CDD1" offset="0%" />
        <stop stop-color="#C6CFD3" stop-opacity="0" offset="100%" />
      </linearGradient>
      <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="oms-lost-l">
        <stop stop-color="#7A87AF" offset="0%" />
        <stop stop-color="#444F77" offset="100%" />
      </linearGradient>
      <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="oms-lost-m">
        <stop stop-color="#7A87AF" offset="0%" />
        <stop stop-color="#444F77" offset="100%" />
      </linearGradient>
      <linearGradient
      ...
      >
        ...
        <stop stop-color="#D2DAE8" offset="100%" />
      </linearGradient>
      <radialGradient
        cx="43.37%"
        cy="34.68%"
        ...
        id="oms-lost-b"
      >
        <stop stop-color="#EBEDF0" stop-opacity="0.24" offset="0%" />
        <stop stop-color="#EBEDF0" stop-opacity="0.846" offset="53.678%" />
        <stop stop-color="#E0E4E7" stop-opacity="0" offset="100%" />
      </radialGradient>
      <path
    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <g transform="translate(.469 27.273)">
        <g transform="translate(0 156.212)">
          <mask id="oms-lost-d" fill="#fff">
            <use href="#oms-lost-a" />
          </mask>
          <use fill="url(#oms-lost-b)" fill-rule="nonzero" href="#oms-lost-a" />
          <ellipse
            fill="url(#oms-lost-c)"
            fill-rule="nonzero"
            opacity="0.672"
        ...
        <g
          opacity="0.321"
          transform="translate(218.546 27.493)"
          fill-rule="nonzero"
        >
          <ellipse
            fill="url(#oms-lost-g)"
