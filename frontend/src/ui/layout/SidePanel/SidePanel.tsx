 ...
 * off-canvas drawer + scrim below it, with a drop shadow — see
 * Page.module.css).
 * Pure layout + look, no open state of its own: the page
 * composes <SidePanelSection>s, hands the panel to Page's `sidePanel` slot, and
 * passes `onClose` (→ the close button, top inline-end). Scrolls independently
 * of the body.
 */
