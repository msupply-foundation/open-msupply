...
import { CalendarIcon, CheckIcon, ChevronDownIcon, CloseIcon, SearchIcon } from '../../icons'
import { t } from '../../../intl'
...
/**
 * A date filter — a native date input behind the calendar icon, sharing the text-filter chrome.
 * Value is an ISO `yyyy-mm-dd` string (native date input's format); '' clears it. Used for
 * "before"/"after" bounds inside a filter's render.
 */
