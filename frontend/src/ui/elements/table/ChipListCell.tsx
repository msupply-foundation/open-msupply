 ...
 *
 * The chips wrap onto further lines when the column is narrow (growing the row,
 * like a wrapping text cell) rather than clipping on one line — which also keeps
 * the column resizable (see the CSS). The container's hover text still carries
 * the full list. An empty list renders a blank cell.
 */
