 ...
 * "which element do I render?" (e.g. docked menu bar vs. hamburger overlay), and
 * are consumed by createMediaQuery to drive conditional rendering — rarely by
 * CSS media queries. This list stays short on purpose.
 */
