...
// OMS-REG-DIST-02.1/.17). The customer role carries the facility/store type
// restriction: patients hold a per-store isCustomer join and would otherwise be
// offered and then rejected on create (issue #657).

describe('roleFilter (OMS-REG-DIST-02.17 — only creatable parties are offered)', () => {
