...
/*
 * Storybook of the InsetPanel layout element: a recessed grey panel that groups
 * related controls with an optional muted hint line. Pure layout/grouping — no
 * interaction or a11y contract — so it lives with the layout elements, not the
 * inputs (the controls it wraps keep their own look). Demoed with the FieldRow +
 * TextField rows it pairs with inside the create-stocktake modal.
 */
