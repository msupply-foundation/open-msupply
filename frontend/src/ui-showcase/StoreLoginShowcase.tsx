...
import { StoreSelector, type StoreOption } from '../ui/elements/selectors/StoreSelector'
...
const STORES: StoreOption[] = [
  { id: 'AFCA0C9F0743AB43B779FB9EA2E64EAF', code: 'Liquica-store', name: 'SMS Liquica Store' },
  { id: '5B28901C52396E4BB098B9862CCF5DF9', code: 'chc_ermera', name: 'CHC Ermera' },
      ...
      <Card
        ...
        lead={
          <>
            ...
            current app's login store-selector — <code>TextField</code> search, a
            bordered selectable list with <code>Default</code> /{' '}
            <code>Last used</code> StatusChips, and a <code>Continue</code>{' '}
            button (select-then-confirm; double-click a row to confirm directly).
            Here it fills a blocking <code>&lt;Dialog&gt;</code>, exactly as the
            app's store login uses it.
          </>
        }
      >
