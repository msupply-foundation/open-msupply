...
// Custom (server-supplied) translations. The server returns a flat key→value map
// for the requested language, overriding the bundled catalog. Proxied to the
// backend in dev (see the dev server proxy in vite.config.ts).
