...
// OMS-REG-SET-05.21 — Test and Save require all four fields: any of address,
// port, label height, or label width empty disables both, regardless of the USB
// toggle (the gate takes no USB input at all — it cannot vary by mode).
...
// OMS-REG-SET-05.22 — the USB preference is device-local: what travels to the
// server is exactly the four network/label fields — no USB flag exists on the
// input.
