...
// rules § Devices — barcode scanner: the mock scanner is a testing aid: enabling it simulates a
...
// rules § Devices — barcode scanner: Test scanner records nothing server-side: a triggered scan is a
