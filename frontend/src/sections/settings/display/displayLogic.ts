...
//  - theme saves gate on a shallow client-side JSON parse (AC-DS2); the logo
//    has NO content validation at all (AC-DS5).
//  - toggling OFF clears immediately with no Save step (AC-DS4, AC-DS6);
