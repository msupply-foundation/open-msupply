...
// (OMS-REG-INV-01.36..OMS-REG-INV-01.19) is testable in node vitest. Filter and sort are exactly the
...
// Default sort: Name ascending (OMS-REG-INV-01.17). URL-backed, so a header click
// overrides it (and is shareable/restorable — OMS-REG-INV-01.14).
 ...
 * by the query's own storeId argument (OMS-REG-INV-01.36); pagination is server-side
 * offset/first (OMS-REG-INV-01.19); stripEmpty drops added-but-empty filter chips (held as
