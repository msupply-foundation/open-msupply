...
// step (OMS-REG-DIST-07.12). The two typed rejections (customer not visible / not a
// customer) surface inline and the modal stays open with the lookup preserved
// (OMS-REG-DIST-07.13); anything non-typed went through the generic error path already.
