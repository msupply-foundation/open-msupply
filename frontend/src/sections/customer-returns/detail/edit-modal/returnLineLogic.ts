...
// (OMS-REG-DIST-07.19–.21, .23) exercise the semantics directly.
...
// never negative. OMS-REG-DIST-07.23.
...
// Step-1 gating (ui-surface S4; the zero-quantity notices — OMS-REG-DIST-07.20, .17's
// UI guard):
...
// would otherwise never reach the reason step and be removed silently (OMS-REG-DIST-07.20).
