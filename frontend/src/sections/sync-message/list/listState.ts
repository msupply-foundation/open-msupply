 ...
 * here so the URL always carries the sort the table shows (OMS-REG-MNG-05.3).
 ...
 * including messages with no destination at all (OMS-REG-MNG-05.2).
 *
 ...
 * (OMS-REG-MNG-05.29). A failed register read leaves the previous page on
 ...
 * everything (D120). Distinguishing the two is exactly what this returns: the
