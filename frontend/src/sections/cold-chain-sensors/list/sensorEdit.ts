 ...
 * the readings and is shown read-only (rules › what the user owns, AC-V1).
 *
 ...
 * device reports would overwrite an edit anyway (rules › naming, AC-N2).
 *
...
/** Whether this sensor's name is the user's to set (AC-N1/AC-N2). */
 ...
 * a save from here cannot move them (AC-V2).
 */
