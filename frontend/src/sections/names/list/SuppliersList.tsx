...
// S2 — Supplier list (from Replenishment). The standard names list scoped to the
// active store's suppliers (AC-N2); a row NAVIGATES to the supplier's detail
// page (AC-N15), unlike the customer list's in-place modal.
