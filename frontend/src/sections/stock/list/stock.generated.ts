...
export type ItemsByStockLineFilterVariables = {
  storeId: string;
  filter?: {
    expiryDate?: {
    equalTo?: string | null;
...
export type ItemsByStockLineFilterResult = {
...
export const ItemsByStockLineFilter = {
  query: "query itemsByStockLineFilter($storeId: String!, $filter: StockLineFilterInput, $sort: [ItemSortInput!], $page: PaginationInput) {\n  itemsByStockLineFilter(\n    storeId: $storeId\n    filter: $filter\n    sort: $sort\n    page: $page\n  ) {\n    ... on ItemConnector {\n      __typename\n      totalCount\n      nodes {\n        id\n        code\n        name\n        unitName\n        isVaccine\n        doses\n        masterLists(storeId: $storeId) {\n          id\n          name\n        }\n        availableBatches(storeId: $storeId) {\n          totalCount\n          nodes {\n            ...StockLineRow\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment StockLineRow on StockLineNode {\n  id\n  itemId\n  itemName\n  batch\n  expiryDate\n  manufactureDate\n  packSize\n  totalNumberOfPacks\n  availableNumberOfPacks\n  costPricePerPack\n  sellPricePerPack\n  onHold\n  supplierName\n  locationName\n  volumePerPack\n  totalVolume\n  location {\n    id\n    code\n    name\n  }\n  vvmStatus {\n    id\n    description\n  }\n  item {\n    id\n    code\n    unitName\n    isVaccine\n    doses\n    masterLists(storeId: $storeId) {\n      id\n      name\n    }\n  }\n  manufacturer(storeId: $storeId) {\n    id\n    name\n  }\n}",
} as TypedDocument<ItemsByStockLineFilterResult, ItemsByStockLineFilterVariables>;
