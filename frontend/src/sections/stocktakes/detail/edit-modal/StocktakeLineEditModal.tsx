...
const StocktakeLineEditContent = (
  ...
  return (
    <Dialog
      ...
      // to 20 columns, so #771's "~900px if the tables fit" does NOT fit — the
      // issue names this table by name ("wider if the stocktake column set
      // forces it"), and 56rem would force horizontal scroll on a desktop table
      // view. Recorded as a deliberate deviation in the DESIGN_STANDARDS
