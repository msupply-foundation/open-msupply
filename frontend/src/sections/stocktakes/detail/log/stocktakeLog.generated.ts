...
export type StocktakeLogFragment = {
  id: string;
  datetime: string;
...
export type StocktakeLogVariables = {
  storeId: string;
  recordId: string;
  page?: {
    first?: number | null;
...
export type StocktakeLogResult = {
  activityLogs: ({
  __typename: "ActivityLogConnector";
} & {
  totalCount: number;
  nodes: Array<StocktakeLogFragment>;
});
};

export const StocktakeLog = {
  query: "query stocktakeLog($storeId: String!, $recordId: String!, $page: PaginationInput, $sort: [ActivityLogSortInput!]) {\n  activityLogs(\n    storeId: $storeId\n    filter: {recordId: {equalTo: $recordId}}\n    page: $page\n    sort: $sort\n  ) {\n    ... on ActivityLogConnector {\n      __typename\n      totalCount\n      nodes {\n        ...StocktakeLog\n      }\n    }\n  }\n}\n\nfragment StocktakeLog on ActivityLogNode {\n  id\n  datetime\n  type\n  to\n  from\n  user {\n    username\n  }\n}",
} as TypedDocument<StocktakeLogResult, StocktakeLogVariables>;
