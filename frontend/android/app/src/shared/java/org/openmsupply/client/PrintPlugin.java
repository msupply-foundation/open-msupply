 ...
 * counterpart to SaveFilePlugin, as a plain Capacitor plugin
 * (kdd/capacitor-plugins § Custom Capacitor plugins).
 * JS side: src/platform/openDocument.ts printBlob.
 *
 ...
 * headless Chrome, which has no executable to launch on Android
 * (open-msupply-frontend#634). So the finished HTML goes to the OS instead.
 *
