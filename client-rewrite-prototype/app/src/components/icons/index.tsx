...
/*
 * Faithful ports of the current app's nav icons
 *   client/packages/common/src/ui/icons/*
 * from MUI SvgIcon to plain SVG (no MUI dependency).
 *
 * Convention preserved from the originals:
 ...
 * exactly like the MUI SvgIcons they replace.
 */
...
export const ThermometerIcon = (props: IconProps) => (
  <Stroke viewBox="0 0 28 64" strokeWidth={3} {...props}>
...
export const ListIcon = (props: IconProps) => (
  <Stroke viewBox="0 0 21 20" {...props}>
...
/* Chevron — used for section toggles and the selected-item indicator */
...
/* Drag handle — two columns of dots, painted as fills. */
...
export const CentralIcon = (props: IconProps) => (
  <Fill viewBox="0 0 512 640" {...props}>
    <path d="M256,153c-36.944,0-67-30.056-67-67s30.056-67,67-67s67,30.056,67,67S292.944,153,256,153z M256,33c-29.224,0-53,23.776-53,53s23.776,53,53,53c29.225,0,53-23.776,53-53S285.225,33,256,33z" />
    <path d="M256,493c-36.944,0-67-30.056-67-67s30.056-67,67-67s67,30.056,67,67S292.944,493,256,493z M256,373c-29.224,0-53,23.775-53,53s23.776,53,53,53c29.225,0,53-23.775,53-53S285.225,373,256,373z" />
    <path d="M426,323c-36.944,0-67-30.056-67-67s30.056-67,67-67s67,30.056,67,67S462.944,323,426,323z M426,203c-29.225,0-53,23.776-53,53c0,29.225,23.775,53,53,53s53-23.775,53-53C479,226.776,455.225,203,426,203z" />
    <path d="M256,323c-36.944,0-67-30.056-67-67s30.056-67,67-67s67,30.056,67,67S292.944,323,256,323z M256,203c-29.224,0-53,23.776-53,53c0,29.225,23.776,53,53,53c29.225,0,53-23.775,53-53C309,226.776,285.225,203,256,203z" />
    <path d="M86,323c-36.944,0-67-30.056-67-67s30.056-67,67-67s67,30.056,67,67S122.944,323,86,323z M86,203c-29.224,0-53,23.776-53,53c0,29.225,23.776,53,53,53s53-23.775,53-53C139,226.776,115.224,203,86,203z" />
 ...
 * copied verbatim from client/.../icons/MSupplyGuy.tsx.
 */
