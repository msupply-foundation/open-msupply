...
![omSupply requisition transfer processors](./images/omSupply_requisition_transfer_workflow.png)

From [TMF internal docs](https://app.diagrams.net/#G1o_xRQAhjVsnqhxhJEu9dY6AZ_lJfG9co)

![omSupply requisition transfer processors](./images/omSupply_requisition_transfer_processors.png)
...
![omSupply requisition transfer same site](./images/omSupply_requisition_transfer_same_site.png)