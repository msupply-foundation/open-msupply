...
use graphql_printer_configuration::{PrinterConfigurationMutations, PrinterConfigurationQueries};
...
pub struct Queries(
    ...
    pub RepackQueries,
    pub PrinterConfigurationQueries,
    pub ProgramsQueries,
...
pub struct Mutations(
    ...
    pub RepackMutations,
    pub PrinterConfigurationMutations,
