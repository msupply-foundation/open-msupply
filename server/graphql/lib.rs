...
use graphql_preference::{CentralPreferenceQueries, PreferenceMutations, PreferenceQueries};
...
impl CentralServerQueryNode {
    ...
    async fn preferences(&self) -> CentralPreferenceQueries {
        CentralPreferenceQueries
    }
}
