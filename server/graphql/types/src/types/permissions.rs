...
impl UserPermission {
    pub fn from_domain(from: &Permission) -> UserPermission {
        match from {
            ...
            Permission::InventoryAdjustmentQuery => UserPermission::InventoryAdjustmentQuery,
    ...
    pub fn to_domain(self) -> Permission {
        match self {
            ...
            UserPermission::InventoryAdjustmentQuery => Permission::InventoryAdjustmentQuery,
