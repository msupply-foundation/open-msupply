...
use repository::assets::{asset_category::AssetCategory, asset_category_row::AssetCategoryRow};
...
impl AssetCategoryConnector {
    pub fn from_domain(asset_categories: ListResult<AssetCategory>) -> AssetCategoryConnector {
