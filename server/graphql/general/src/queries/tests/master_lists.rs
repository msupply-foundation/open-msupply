            ...
            assert_eq!(
                ...
                Some(
                    MasterListFilter::new()
                        .id(EqualFilter::equal_to("test_id_filter".to_owned()))
                        ...
                        .exists_for_name_id(EqualFilter::not_equal_to("test_name_id_filter".to_owned()))
                        .exists_for_store_id(EqualFilter::equal_to("store_a".to_owned()))
                        .is_program(false)
                )
            );
            Ok(ListResult::empty())
