...
#[derive(Interface)]
#[graphql(name = "DeletePurchaseOrderInterface")]
...
#[derive(InputObject)]
#[graphql(name = "DeletePurchaseOrderInput")]
...
pub fn delete_purchase_order(
    ...
    map_response(
        service_provider
            ...
            .delete_purchase_order(&service_context, input.to_domain()),
    )
}
...
fn map_error(error: ServiceError) -> Result<DeleteErrorInterface> {
    ...
    let graphql_error = match error {
        ...
        ServiceError::NotThisStorePurchaseOrder | ServiceError::CannotEditPurchaseOrder => {
