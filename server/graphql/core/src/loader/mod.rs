...
mod patient;
mod prescription_request_lines;
...
mod vaccine_course_store_config_by_vaccine_course;
mod vvm_status;
mod vvm_status_log;
mod warning;
...
pub use patient::*;
pub use prescription_request_lines::*;
...
pub use vaccine_course_store_config_by_vaccine_course::*;
pub use vvm_status::*;
