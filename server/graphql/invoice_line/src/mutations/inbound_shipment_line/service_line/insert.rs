...
#[derive(SimpleObject)]
#[graphql(name = "InsertInboundShipmentServiceLineError")]
pub struct InsertError {
    pub error: InsertErrorInterface,
}

#[derive(Union)]
#[graphql(name = "InsertInboundShipmentServiceLineResponse")]
...
#[derive(Interface)]
#[graphql(name = "InsertInboundShipmentServiceLineErrorInterface")]
...
mod test {
    ...
    async fn test_graphql_insert_inbound_shipment_service_line() {
        ...
        let mutation = r#"
        mutation ($input: InsertInboundShipmentServiceLineInput!, $storeId: String) {
            insertInboundShipmentServiceLine(storeId: $storeId, input: $input) {
