...
const VVM_STATUS_LOG_1: (&str, &str) = (
    ...
    r#"{
        ...
        "date": "2025-05-08T00:00:00.00000",
...
const VVM_STATUS_LOG_2: (&str, &str) = (
    ...
    r#"{
        ...
        "date": "2025-05-09T14:30:00.00000",
...
fn vvm_status_log_1() -> VVMStatusLogRow {
    VVMStatusLogRow {
        id: VVM_STATUS_LOG_1.0.to_string(),
        status_id: "VVM_STATUS_1".to_string(),
        created_datetime: NaiveDate::from_ymd_opt(2025, 5, 8)
            .unwrap()
            .and_hms_opt(0, 00, 00)
            .unwrap()
            + Duration::seconds(00000),
...
fn vvm_status_log_2() -> VVMStatusLogRow {
    VVMStatusLogRow {
        id: VVM_STATUS_LOG_2.0.to_string(),
        status_id: "VVM_STATUS_2".to_string(),
        created_datetime: NaiveDate::from_ymd_opt(2025, 5, 9)
            .unwrap()
            .and_hms_opt(14, 30, 00)
            .unwrap()
            + Duration::seconds(00000),
...
pub(crate) fn test_pull_upsert_records() -> Vec<TestSyncIncomingRecord> {
    vec![
        TestSyncIncomingRecord::new_pull_upsert(TABLE_NAME, VVM_STATUS_LOG_1, vvm_status_log_1()),
        TestSyncIncomingRecord::new_pull_upsert(TABLE_NAME, VVM_STATUS_LOG_2, vvm_status_log_2()),
    ]
}
