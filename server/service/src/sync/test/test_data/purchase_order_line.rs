...
const PURCHASE_ORDER_LINE_1: (&str, &str) = (
    ...
    r#"{
        ...
        "purchase_order_ID": "test_purchase_order_1",
		"line_number": 1,
		"item_ID": "item_a_id",
...
fn purchase_order_line_pull_record() -> TestSyncIncomingRecord {
    TestSyncIncomingRecord::new_pull_upsert(
        ...
        PurchaseOrderLineRow {
            ...
            purchase_order_id: "test_purchase_order_1".to_string(),
            line_number: Some(1),
            item_link_id: Some("item_a_id".to_string()),
            item_name: Some("item_a_name".to_string()),
