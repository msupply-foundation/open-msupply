    ...
    vec![
        ...
        TestSyncIncomingRecord::new_pull_upsert(
            ...
            MasterListRow {
                ...
                code: "".to_string(),
                description: "National Price List".to_string(),
                is_active: true,
                is_default_price_list: true,
        ...
        TestSyncIncomingRecord::new_pull_upsert(
            ...
            MasterListRow {
                ...
                code: "".to_string(),
                description: "National Price List Store Discounts".to_string(),
                is_active: true,
                is_default_price_list: false,
