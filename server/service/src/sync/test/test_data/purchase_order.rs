use crate::sync::{
    ...
    translations::{
        ...
        purchase_order::{LegacyPurchaseOrderRow, LegacyPurchaseOrderStatus},
    },
};
...
fn purchase_order_push_record() -> TestSyncOutgoingRecord {
    TestSyncOutgoingRecord {
        ...
        push_data: json!(LegacyPurchaseOrderRow {
            ...
            store_id: "store_b".to_string(),
            supplier_agent: None,
            authorizing_officer_1: None,
            authorizing_officer_2: None,
            freight_conditions: None,
            additional_instructions: None,
            agent_commission: None,
            document_charge: None,
...
pub(crate) fn test_pull_upsert_records() -> Vec<TestSyncIncomingRecord> {
    vec![purchase_order_pull_record()]
}

pub(crate) fn test_push_records() -> Vec<TestSyncOutgoingRecord> {
    vec![purchase_order_push_record()]
}
