...
// This is the linked counterpart to the above cancelled prescription
const CANCELLATION_PRESCRIPTION: (&str, &str) = (
    "cancellation_prescription",
    r#"{
      "Colour": 0,
      "Date_order_received": "0000-00-00",
      "Date_order_written": "2021-07-30",
      "ID": "cancellation_prescription",
      "amount_outstanding": 0,
      "arrival_date_actual": "0000-00-00",
      "arrival_date_estimated": "0000-00-00",
      "authorisationStatus": "",
      ...
      "lastModifiedAt": 1627607293,
      "linked_goods_received_ID": "",
      "linked_transaction_id": "cancelled_prescription",
      "local_charge_distributed": 0,
      "mode": "dispensary",
      "mwks_sequence_num": 0,
      "nameInsuranceJoinID": "",
