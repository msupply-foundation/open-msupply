    ...
    TestSyncOutgoingRecord {
        ...
        push_data: json!(LegacyTransLineRow {
            ...
            oms_fields: Some(TransLineRowOmsFields {
                ...
                rejected_number_of_packs: Some(12.0),
            }),
            shipped_number_of_packs: Some(0.0),
            volume_per_pack: 0.0,
            shipped_pack_size: Some(100.0),
...
const TRANS_LINE_PRESCRIBED_QUANTITY: (&str, &str) = (
    "C6CF33BB6BD94D30BF0F691CB9A3E9FD",
    r#"{        
...
fn trans_line_prescribed_quantity_pull_record() -> TestSyncIncomingRecord {
    TestSyncIncomingRecord::new_pull_upsert(
        TABLE_NAME,
...
fn trans_line_prescribed_quantity_push_record() -> TestSyncOutgoingRecord {
    TestSyncOutgoingRecord {
        table_name: TABLE_NAME.to_string(),
        record_id: TRANS_LINE_PRESCRIBED_QUANTITY.0.to_string(),
        push_data: json!(LegacyTransLineRow {
            id: TRANS_LINE_PRESCRIBED_QUANTITY.0.to_string(),
            invoice_id: "outbound_shipment_a".to_string(),
            item_id: mock_item_a().id,
            ...
            cost_price_per_pack: 10.0,
            sell_price_per_pack: 10.0,
            total_before_tax: Some(10.0),
            total_after_tax: Some(10.0),
            tax_percentage: None,
            r#type: LegacyTransLineType::StockOut,
            number_of_packs: 1.0,
            prescribed_quantity: Some(21.0),
