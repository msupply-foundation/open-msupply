    ...
    vec![
        ...
        TestSyncIncomingRecord::new_pull_upsert(
            ...
            ItemRow {
                ...
                is_vaccine: false,
                vaccine_doses: 0,
                restricted_location_type_id: Some("84AA2B7A18694A2AB1E84DCABAD19617".to_owned()),
                ..Default::default()
            },
        ),
...
pub(crate) fn test_clear_restricted_location_type_records() -> Vec<TestSyncIncomingRecord> {
    // Create modified ITEM_2 data with cleared restriction
    let item_2_cleared_json = r#"{
    "ID": "8F252B5884B74888AAB73A0D42C09E7F",
    "item_name": "Non stock items 2",
    "start_of_year_date": "0000-00-00",
    "manufacture_method": "",
    ...
    vec![TestSyncIncomingRecord::new_pull_upsert(
        TABLE_NAME,
        (ITEM_2.0, &ordered_simple_json(item_2_cleared_json).unwrap()),
        ItemRow {
            id: ITEM_2.0.to_owned(),
            name: "Non stock items 2".to_owned(),
            code: "NSI".to_owned(),
            unit_id: Some("A02C91EB6C77400BA783C4CD7C565F29".to_owned()),
            r#type: ItemType::Stock,
            legacy_record: ordered_simple_json(item_2_cleared_json).unwrap(),
            default_pack_size: 2.0,
            is_active: true,
            is_vaccine: false,
            vaccine_doses: 0,
