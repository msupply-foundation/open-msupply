...
pub(crate) static SYNC_V6_VERSION: u32 = 6; // bumped for item_link abstraction (#10748): row structs serialize *_link_id via serde rename so older clients can still pull from an upgraded central
