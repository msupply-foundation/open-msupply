...
impl SyncTranslation for InvoiceTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        let name_store_id = StoreRepository::new(connection)
            .query_by_filter(StoreFilter::new().name_id(EqualFilter::equal_to(data.name_ID.to_owned())))?
            .pop()
    ...
    fn try_translate_to_upsert_sync_record(
        ...
        let Some(invoice) = InvoiceRepository::new(connection)
            .query_by_filter(InvoiceFilter::new().id(EqualFilter::equal_to(changelog.record_id.to_owned())))?
            .pop()
        else {
