use repository::{
    asset_class_row::AssetClassRow, ChangelogRow, ChangelogTableName, Row, StorageConnection,
    SyncBufferRow,
};
...
impl SyncTranslation for AssetClassTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        Ok(PullTranslateResult::upsert(Row::AssetClass(
            serde_json::from_value::<AssetClassRow>(sync_record.data.0.clone())?,
        )))
    }
