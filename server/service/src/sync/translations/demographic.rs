use repository::{
    demographic_row::DemographicRow, ChangelogRow, ChangelogTableName, Row, StorageConnection,
    SyncBufferRow,
};
...
impl SyncTranslation for DemographicTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        Ok(PullTranslateResult::upsert(Row::Demographic(
            serde_json::from_value::<DemographicRow>(sync_record.data.0.clone())?,
        )))
    }
