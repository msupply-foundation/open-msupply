...
impl SyncTranslation for IndicatorValue {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        let customer_name_link_id = StoreRepository::new(connection)
            .query_one(StoreFilter::new().id(EqualFilter::equal_to(customer_store_id.to_owned())))?
            .ok_or(anyhow::anyhow!(
    ...
    fn try_translate_to_upsert_sync_record(
        ...
        let Some(indicator_value) = IndicatorValueRepository::new(connection)
            .query_by_filter(
                IndicatorValueFilter::new().id(EqualFilter::equal_to(changelog.record_id.to_owned())),
            )?
            .pop()
        else {
        ...
        let customer_store_id = StoreRepository::new(connection)
            .query_one(StoreFilter::new().name_id(EqualFilter::equal_to(customer_name_link_id.to_owned())))?
            .ok_or(anyhow::anyhow!(
