use repository::{
    system_log_row::SystemLogRow, ChangelogRow, ChangelogTableName, Row, StorageConnection,
    SyncBufferRow,
};
...
impl SyncTranslation for SystemLogTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        Ok(PullTranslateResult::upsert(Row::SystemLog(
            serde_json::from_value::<SystemLogRow>(sync_record.data.0.clone())?,
        )))
    }
