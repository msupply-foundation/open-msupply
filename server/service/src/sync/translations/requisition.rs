...
use util::constants::{APPROX_NUMBER_OF_DAYS_IN_A_MONTH, MISSING_PROGRAM};
...
impl SyncTranslation for RequisitionTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        let (
            ...
            None => (
                ...
                data.daysToSupply as f64 / APPROX_NUMBER_OF_DAYS_IN_A_MONTH,
    ...
    fn try_translate_to_upsert_sync_record(
        ...
        let legacy_row = LegacyRequisitionRow {
            ...
            daysToSupply: (APPROX_NUMBER_OF_DAYS_IN_A_MONTH * max_months_of_stock) as i64,
