...
mod tests {
    ...
    use repository::{
        ...
        vaccine_course::vaccine_course_item_row::{VaccineCourseItemRow, VaccineCourseItemRowRepository}, ChangelogRepository,
    };
    ...
    async fn test_vaccine_course_item_legacy_translation() {
        ...
        match translation_result {
            TranslatedUpsert::Translated(upsert_result) => {
                assert_eq!(upsert_result["ID"], "test_vaccine_course_item_id");
            }
