...
impl SyncTranslation for RequisitionLineTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        let result = RequisitionLineRow {
            ...
            average_monthly_consumption: (data.daily_usage * APPROX_NUMBER_OF_DAYS_IN_A_MONTH).ceil(),
    ...
    fn try_translate_to_upsert_sync_record(
        ...
        let legacy_row = LegacyRequisitionLineRow {
            ...
            daily_usage: average_monthly_consumption / APPROX_NUMBER_OF_DAYS_IN_A_MONTH,
            comment,
            snapshot_datetime,
            approved_quantity,
            approval_comment,
