...
pub(crate) fn all_translators() -> SyncTranslators {
    ...
    .into_iter()
    .chain(translator_v7::all_translators_v7().into_iter())
    .collect()
}
...
pub(crate) enum ToSyncRecordTranslationType {
    ...
    PullFromOmSupplyCentralV6,

    PushToOmSupplyCentralV7,
    PullFromOmSupplyCentralV7,
}
...
pub(crate) trait SyncTranslation {
    ...
    fn should_translate_to_sync_record(
        ...
        match r#type {
            ...
            ToSyncRecordTranslationType::PullFromOmSupplyCentralV6 => false,
            ToSyncRecordTranslationType::PullFromOmSupplyCentralV7 => false,
            ToSyncRecordTranslationType::PushToOmSupplyCentralV7 => false,
        }
    }
