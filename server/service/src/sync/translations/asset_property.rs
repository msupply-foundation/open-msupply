use repository::{
    asset_property_row::AssetPropertyRow, ChangelogRow, ChangelogTableName, Row, StorageConnection,
    SyncBufferRow,
};
...
impl SyncTranslation for AssetPropertyTranslation {
    ...
    fn try_translate_from_upsert_sync_record(
        ...
        Ok(PullTranslateResult::upsert(Row::AssetProperty(
            serde_json::from_value::<AssetPropertyRow>(sync_record.data.0.clone())?,
        )))
    }
