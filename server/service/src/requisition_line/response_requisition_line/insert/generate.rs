...
pub fn generate(
    ...
    InsertResponseRequisitionLine {
        ...
        requisition_id: _,
        item_id,
        stock_on_hand: initial_stock_on_hand,
        requested_quantity,
        supply_quantity,
        comment,
    }: InsertResponseRequisitionLine,
    ...
    if requisition_row.linked_requisition_id.is_none() {
        new_requisition_line.available_stock_on_hand =
            initial_stock_on_hand.unwrap_or(new_requisition_line.available_stock_on_hand);
    }
    new_requisition_line.initial_stock_on_hand_units = initial_stock_on_hand.unwrap_or(0.0);
