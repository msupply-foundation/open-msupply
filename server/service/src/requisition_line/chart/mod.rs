...
mod test {
    ...
    use util::{
        constants::APPROX_NUMBER_OF_DAYS_IN_A_MONTH, date_now, inline_edit, inline_init, uuid::uuid,
    };
            ...
            vec![
                ConsumptionHistory {
                    ...
                    average_monthly_consumption: (30 + 40 + 5 + 5 + 20 + 15 + 40) as f64
                        ...
                        .num_days() as f64
                        * APPROX_NUMBER_OF_DAYS_IN_A_MONTH,
    ...
    async fn get_requisition_line_chart_stock_evolution() {
        ...
        fn requisition_line() -> RequisitionLineRow {
            inline_init(|r: &mut RequisitionLineRow| {
                ...
                r.average_monthly_consumption = 25.0 * APPROX_NUMBER_OF_DAYS_IN_A_MONTH;
