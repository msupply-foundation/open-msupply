...
fn update_encounter_row(
    ...
    let encounter = repo
        .query_by_filter(EncounterFilter::new().document_name(EqualFilter::equal_to_string(&doc.name)))?
        .pop();
        ...
        let insert_and_delete = |insert_time: i64, delete_time: i64| {
            ...
            let events = service_provider
                ...
                .events(
                    &context,
                    None,
                    Some(ProgramEventFilter::new().patient_id(EqualFilter::equal_to_string(&patient.id))),
                    None,
                    None,
                )
                .unwrap();
