use repository::{
    ...
    AbbreviationRow, ActivityLogRow, AssetCatalogueItemRow, AssetCategoryRow, AssetClassRow,
    AssetInternalLocationRow, AssetLogReasonRow, AssetLogRow, AssetPropertyRow, AssetRow,
    AssetTypeRow,
    BackendPluginRow, BarcodeRow, BundledItemRow, CampaignRow, ChangelogTableName, ClinicianRow,
    ClinicianStoreJoinRow, ContactFormRow, ContactRow, ContextRow, CurrencyRow,
    DemographicIndicatorRow, DemographicRow, DiagnosisRow, DocumentRegistryRow, DocumentRow,
    EncounterRow, FormSchemaRow, FrontendPluginRow, IndicatorColumnRow, IndicatorLineRow,
    IndicatorValueRow,
    InsuranceProviderRow, InvoiceLineRow, InvoiceRow, ItemDirectionRow, ItemRow,
    ItemStoreJoinRow, ItemVariantRow, ItemWarningJoinRow, LocationMovementRow, LocationRow,
    LocationTypeRow,
    MasterListLineRow, MasterListNameJoinRow, MasterListRow, NameInsuranceJoinRow,
    NameOmsFieldsRow, NamePropertyRow, NameRow, NameStoreJoinRow, NameTagJoinRow, NameTagRow,
    PackagingVariantRow, PeriodRow, PeriodScheduleRow, PluginDataRow, PreferenceRow, PrinterRow,
    ProgramEnrolmentRow, ProgramEventRow, ProgramIndicatorRow, ProgramRequisitionOrderTypeRow,
    ProgramRequisitionSettingsRow, ProgramRow, PropertyRow, PurchaseOrderLineRow, PurchaseOrderRow,
    ReasonOptionRow, ReportRow, RequisitionLineRow, RequisitionRow, RnRFormLineRow, RnRFormRow,
    Row, SensorRow, ShippingMethodRow, SiteRow, StockLineRow, StocktakeLineRow, StocktakeRow,
    StorePreferenceRow, StoreRow, SyncFileReferenceRow, SyncMessageRow, SystemLogRow,
    TemperatureBreachRow, TemperatureLogRow, UnitRow, Upsert, UserAccountRow, UserPermissionRow,
    UserStoreJoinRow, VVMStatusLogRow, VVMStatusRow, VaccinationRow, VaccineCourseDoseRow,
    VaccineCourseItemRow, VaccineCourseRow, VaccineCourseStoreConfigRow,
};
