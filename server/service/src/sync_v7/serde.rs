...
pub fn serialize(row: &Row) -> Result<serde_json::Value, SyncRecordSerializeError> {
    ...
    match row {
        ...
        Row::PropertyV2(r) => serde_json::to_value(r).map_err(map_serde_err),
        Row::PropertyOptionV2(r) => serde_json::to_value(r).map_err(map_serde_err),
        Row::PropertyTableV2(r) => serde_json::to_value(r).map_err(map_serde_err),
...
pub(crate) fn deserialize(
    ...
    let upsert = match table_name {
        ...
        ChangelogTableName::PropertyV2 => from_value::<PropertyV2Row>(data),
        ChangelogTableName::PropertyOptionV2 => from_value::<PropertyOptionV2Row>(data),
        ChangelogTableName::PropertyTableV2 => from_value::<PropertyTableV2Row>(data),
