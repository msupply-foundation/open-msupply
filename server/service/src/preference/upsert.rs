...
pub struct UpsertPreferences {
    ...
    pub inbound_shipment_auto_finalise: Option<Vec<StorePrefUpdate<bool>>>,
...
pub fn upsert_preferences(
    ...
    UpsertPreferences {
        ...
        inbound_shipment_auto_finalise: inbound_shipment_auto_finalise_input,
    ...
    ctx.connection
        .transaction_sync(|connection| {
            ...
            if let Some(inputs) = inbound_shipment_auto_finalise_input {
                upsert_store_input(connection, inbound_shipment_auto_finalise, inputs)?;
            }
