...
pub mod show_indicative_unit_price_in_requisitions;
pub use show_indicative_unit_price_in_requisitions::*;
...
pub struct PreferenceProvider {
    ...
    pub show_indicative_unit_price_in_requisitions: ShowIndicativeUnitPriceInRequisitions,
...
pub fn get_preference_provider() -> PreferenceProvider {
    PreferenceProvider {
        ...
        show_indicative_unit_price_in_requisitions: ShowIndicativeUnitPriceInRequisitions,
