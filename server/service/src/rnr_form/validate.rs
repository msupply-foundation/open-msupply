...
pub fn check_rnr_form_exists(
    ...
    RnRFormRepository::new(connection)
        .query_one(RnRFormFilter::new().id(EqualFilter::equal_to(rnr_form_id.to_owned())))
}
...
pub fn check_rnr_form_already_exists_for_period(
    ...
    Ok(PeriodRepository::new(connection)
        .query_by_filter(
            ...
            PeriodFilter::new()
                .id(EqualFilter::equal_to(period_id.to_owned()))
                .rnr_form_program_id(EqualFilter::equal_to(program_id.to_owned())),
        )?
        .pop())
}
