...
pub fn check_rnr_form_exists(
    ...
    RnRFormRepository::new(connection)
        .query_one(RnRFormFilter::new().id(EqualFilter::equal_to_string(rnr_form_id)))
}
...
pub fn check_rnr_form_already_exists_for_period(
    ...
    Ok(PeriodRepository::new(connection)
        .query_by_filter(
            ...
            PeriodFilter::new()
                .id(EqualFilter::equal_to_string(period_id))
                .rnr_form_program_id(EqualFilter::equal_to_string(program_id)),
        )?
        .pop())
}
