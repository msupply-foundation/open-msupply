...
mod insert {
    ...
    async fn insert_rnr_form_success() {
        ...
        assert_eq!(form_lines[0].average_monthly_consumption, 4.085418984056359); // 5 (Form A) + 7 (Form B) + 0 (this period) / 3 ... decimals due to more/less than 30 days in period
