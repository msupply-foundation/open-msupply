...
pub fn generate(
    ...
    updated_order.supplier_name_id = supplier_id.unwrap_or(updated_order.supplier_name_id);
    updated_order.donor_id = donor_id.map(|d| d.value).unwrap_or(updated_order.donor_id);
