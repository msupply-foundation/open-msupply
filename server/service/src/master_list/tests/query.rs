    ...
    async fn master_list_service_filter() {
            ...
            .get_master_lists(
                ...
                Some(
                    MasterListFilter::new()
                        .exists_for_name_id(EqualFilter::equal_to("name_store_a".to_owned())),
                ),
                None,
            )
            .unwrap();
        ...
        let result = service
            .get_master_lists(
                &context,
                None,
                Some(MasterListFilter::new().exists_for_store_id(EqualFilter::equal_to("store_a".to_owned()))),
                None,
            )
            .unwrap();
        ...
        let result = service
            .get_master_lists(
                ...
                Some(
                    MasterListFilter::new()
                        .exists_for_store_id(EqualFilter::equal_to("not_a_real_store".to_owned())),
                ),
                None,
            )
            .unwrap();
