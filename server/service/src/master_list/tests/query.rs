    ...
    async fn master_list_service_filter() {
            ...
            .get_master_lists(
                ...
                Some(
                    MasterListFilter::new()
                        .exists_for_name_id(EqualFilter::equal_to_string("name_store_a")),
                ),
                None,
            )
            .unwrap();
        ...
        let result = service
            .get_master_lists(
                &context,
                None,
                Some(MasterListFilter::new().exists_for_store_id(EqualFilter::equal_to_string("store_a"))),
                None,
            )
            .unwrap();
        ...
        let result = service
            .get_master_lists(
                ...
                Some(
                    MasterListFilter::new()
                        .exists_for_store_id(EqualFilter::equal_to_string("not_a_real_store")),
                ),
                None,
            )
            .unwrap();
