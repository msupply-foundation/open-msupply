...
use service::{
    auth_data::AuthData,
    print::label::{host_status, print_data_matrix_barcode, print_prescription_label, PrescriptionLabelData},
...
pub async fn print_label_qr(
    ...
    match print_data_matrix_barcode(settings, data.code.clone(), data.message.clone()) {
