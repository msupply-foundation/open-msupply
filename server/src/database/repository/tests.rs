    ...
    mod data {
        ...
        pub fn invoice_line_1() -> InvoiceLineRow {
            InvoiceLineRow {
                ...
                expiry_date: Some(NaiveDateTime::from_timestamp(2 * 24 * 60 * 60, 0).date()),
                pack_size: 1,
                cost_price_per_pack: 0.0,
                sell_price_per_pack: 0.0,
                total_after_tax: 1.0,
        ...
        pub fn invoice_line_2() -> InvoiceLineRow {
            InvoiceLineRow {
                ...
                stock_line_id: None,
                batch: Some("".to_string()),
                expiry_date: Some(NaiveDateTime::from_timestamp(3 * 24 * 60 * 60, 0).date()),
                pack_size: 1,
                cost_price_per_pack: 0.0,
                sell_price_per_pack: 0.0,
                total_after_tax: 2.0,
        ...
        pub fn invoice_line_3() -> InvoiceLineRow {
            InvoiceLineRow {
                ...
                stock_line_id: None,
                batch: Some("".to_string()),
                expiry_date: Some(NaiveDateTime::from_timestamp(4 * 24 * 60 * 60, 0).date()),
                pack_size: 1,
                cost_price_per_pack: 0.0,
                sell_price_per_pack: 0.0,
                total_after_tax: 3.0,
