...
describe("Adds monthlyConsumption correctly from query result", () => {
  it("returns 0 if either are undefined", () => {
    ...
    expect(calculateQuantity(inputData.thisMonthConsumption, undefined)).toBe(0);
  ...
  it("returns 0 if non existent id", () => {
    expect(calculateQuantity(inputData.thisMonthConsumption, "non existent id")).toBe(0)
  });
});
...
describe("Adds lastMonthConsumption correctly from query result", () => {
  it("returns 0 if either are undefined", () => {
    expect(calculateQuantity(undefined, "id")).toBe(0);
    expect(calculateQuantity(inputData.lastMonthConsumption, undefined)).toBe(0);
  ...
  it("returns 0 if non existent id", () => {
    expect(calculateQuantity(inputData.lastMonthConsumption, "non existent id")).toBe(0)
  });
});
...
describe("Adds twoMonthsAgoConsumption correctly from query result", () => {
  it("returns 0 if either are undefined", () => {
    expect(calculateQuantity(undefined, "id")).toBe(0);
    expect(calculateQuantity(inputData.twoMonthsAgoConsumption, undefined)).toBe(0);
  ...
  it("returns 0 if non existent id", () => {
    expect(calculateQuantity(inputData.twoMonthsAgoConsumption, "non existent id")).toBe(0)
  });
});
...
describe("Adds expiringInSixMonths correctly from query result", () => {
  ...
  it("returns 0 if non existent id", () => {
    expect(calculateQuantity(inputData.expiringInSixMonths, "non existent id")).toBe(0)
  });
});
...
describe("Adds expiringIntwelveMonths correctly from query result", () => {
  it("returns 0 if either are undefined", () => {
    expect(calculateQuantity(undefined, "id")).toBe(0);
    expect(calculateQuantity(inputData.expiringInTwelveMonths, undefined)).toBe(0);
  });
  it("returns month consumption if available", () => {
    expect(calculateQuantity(inputData.expiringInTwelveMonths, "102")).toBe(92);
  });
  it("returns 0 if non existent id", () => {
    expect(calculateQuantity(inputData.expiringInTwelveMonths, "non existent id")).toBe(0)
  });
});
...
describe("Adds AMC24 correctly from query result", () => {
  ...
  it("returns 0 if non existent id", () => {
    expect(calculateQuantity(inputData.AMCTwentyFour, "non existent id")).toBe(0)
  });
});
