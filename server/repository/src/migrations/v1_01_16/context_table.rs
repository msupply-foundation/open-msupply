...
pub(crate) fn migrate(connection: &StorageConnection) -> anyhow::Result<()> {
    ...
    sql!(
        ...
        r#"
            ...
            ALTER TABLE document_registry ADD COLUMN document_context_id TEXT REFERENCES context(id);
            UPDATE document_registry SET document_context_id = document_context;
    ...
    sql!(
        ...
        ALTER TABLE document_registry RENAME COLUMN document_context TO document_context_id;
        ALTER TABLE document_registry ADD CONSTRAINT document_registry_document_context_id_fkey FOREIGN KEY (document_context_id) REFERENCES context(id);
