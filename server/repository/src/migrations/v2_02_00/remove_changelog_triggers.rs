...
impl MigrationFragment for Migrate {
    fn identifier(&self) -> &'static str {
        "remove_changelog_triggers"
    }

    fn migrate(&self, connection: &StorageConnection) -> anyhow::Result<()> {
        #[cfg(not(feature = "postgres"))]
        {
            self.migrate_sqlite(connection)?;
        }

        #[cfg(feature = "postgres")]
        {
            self.migrate_postgres(connection)?;
        }
...
impl Migrate {
    #[cfg(not(feature = "postgres"))]
    fn migrate_sqlite(&self, connection: &StorageConnection) -> anyhow::Result<()> {
        sql!(
            connection,
            r#"
    ...
    #[cfg(feature = "postgres")]
    fn migrate_postgres(&self, connection: &StorageConnection) -> anyhow::Result<()> {
        sql!(
            connection,
            r#"
