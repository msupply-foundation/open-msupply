...
mod tests {
    ...
    /// Insert a v2.17-shaped row with `vaccine_courses` populated, run the
    /// v2.20 migration, and assert the row is reshaped into the new
    ...
    async fn test_refactor_requisition_line_forecasting_migration() {
        ...
        use crate::migrations::v2_20_00::V2_20_00;
