  ...
  CREATE VIEW stock_movement AS
    WITH all_movements AS (
      SELECT
        ...
        stock_line_id,
        stock_line.expiry_date AS expiry_date,
        stock_line.batch AS batch,
        stock_line.cost_price_per_pack AS cost_price_per_pack,
        stock_line.sell_price_per_pack AS sell_price_per_pack,
