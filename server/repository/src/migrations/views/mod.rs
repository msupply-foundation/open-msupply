  ...
  CREATE VIEW vaccination_card AS
    ...
    CREATE VIEW vaccination_course AS 
      SELECT
        ...
        vc.is_active,
        wastage_rate,
        vc.deleted_datetime AS vaccine_course_deleted_datetime,
        vcd.id AS vaccine_course_dose_id,
        LABEL AS dose_label,
        min_interval_days,
        min_age,
        max_age,
        vcd.deleted_datetime AS vaccine_course_dose_deleted_datetime,
        custom_age_label,
        vci.id AS vaccine_course_item_id,
        vci.deleted_datetime AS vaccine_course_item_deleted_datetime,
        item_link_id,
        item.id AS item_id,
        item.name AS item_name,
