...
impl MigrationFragment for Migrate {
    fn identifier(&self) -> &'static str {
        "reintegrate_label_prefs_for_custom_field_names"
    }
    ...
    /// the seeded mapping custom_field names. But those pref records were
    ...
    /// `reintegrate_categories_for_custom_field_options`) and the next sync cycle
    /// re-runs the label translators over them, after the mapping custom_fields
    /// are seeded.
    ///
