use super::{
    ...
    cold_storage_type_row::cold_storage_type, item_row::item, StorageConnection,
};
...
allow_tables_to_appear_in_same_query!(item_link, cold_storage_type);
