use super::{
    invoice_line_row::invoice_line, invoice_row::invoice, item_row::item,
...
fn to_domain(
    (invoice_line_row, item_row, invoice_row, location_row_option, stock_line_option, _): InvoiceLineJoin,
) -> InvoiceLine {
    InvoiceLine {
        invoice_line_row,
        invoice_row,
