...
table! {
    vaccination_course (id) {
        ...
        is_active -> Bool,
        wastage_rate -> Double,
        vaccine_course_deleted_datetime -> Nullable<Timestamp>,
        vaccine_course_dose_id -> Text,
        dose_label -> Text,
        min_interval_days -> Integer,
        min_age -> Double,
        max_age -> Double,
        vaccine_course_dose_deleted_datetime -> Nullable<Timestamp>,
        custom_age_label -> Nullable<Text>,
        vaccine_course_item_id -> Text,
        vaccine_course_item_deleted_datetime -> Nullable<Timestamp>,
        item_link_id -> Text,
        item_id -> Text,
        item_name -> Text,
        item_code -> Text,
...
pub struct VaccinationCourseRow {
    ...
    pub vaccine_course_deleted_datetime: Option<chrono::NaiveDateTime>,
    pub vaccine_course_dose_id: String,
    pub dose_label: String,
    pub min_interval_days: i32,
    pub min_age: f64,
    pub max_age: f64,
    pub vaccine_course_dose_deleted_datetime: Option<chrono::NaiveDateTime>,
    pub custom_age_label: Option<String>,
    pub vaccine_course_item_id: String,
    pub vaccine_course_item_deleted_datetime: Option<chrono::NaiveDateTime>,
