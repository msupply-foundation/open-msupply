...
#[derive(DbEnum, Debug, Clone, PartialEq, Eq, Serialize, Deserialize, TS, Default, schemars::JsonSchema)]
...
#[derive(
    Clone, Queryable, Insertable, Debug, PartialEq, Eq, AsChangeset, Default, Serialize, Deserialize, schemars::JsonSchema)]
#[diesel(treat_none_as_null = true)]
