// Backend-conditional sql_type alias for custom_fields-v2 JSON columns.
//
...
pub type CustomFieldsJson = diesel::sql_types::Jsonb;
#[cfg(not(feature = "postgres"))]
pub type CustomFieldsJson = diesel::sql_types::Json;

/// Re-export of `serde_json::Value` for use as the Rust-side type of
/// `CustomFieldsJson` columns. Improves readability at row-struct sites.
