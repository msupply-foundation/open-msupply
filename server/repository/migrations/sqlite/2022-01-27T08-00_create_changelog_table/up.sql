CREATE TABLE changelog (
    ...
    table_name TEXT CHECK (table_name IN ('number', 'stocktake', 'stock_line', 'name_store_join', 'invoice', 'invoice_line', 'stocktake', 'stocktake_line', 'requisition', 'requisition_line')) NOT NULL,
