...
2. Install Docker and ensure it's running. This can be the official Docker Desktop or an alternative like Orbstack. You can also use docker on a remote host. See advanced installation details on the devcontainers extension readme.
3. Open this repository in VS Code and click **Reopen in Container** when prompted (or run **Dev Containers: Reopen in Container** from the command palette) (or click the remote connection icon in the bottom left to get a full list of options like rebuild container).
