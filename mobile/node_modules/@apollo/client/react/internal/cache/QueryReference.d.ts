...
export interface QueryReference<TData = unknown, TVariables = unknown> extends QueryRef<TData, TVariables> {
     ...
     * @deprecated
     * 
     * `toPromise` has been changed in Apollo Client 4.0 and is no longer available on the returned `queryRef`.
     * 
     * **Recommended now**
     * 
     * `preloadQuery` provides a `.toPromise` method in 3.14.0. Use `preloadQuery.toPromise(queryRef)` instead.
     * 
     * @example
     * 
