...
export type TemperatureBreachesQueryVariables = Types.Exact<{
...
export type TemperatureBreachesQuery = {
  __typename: 'Queries';
  temperatureBreaches: {
...
export type UpdateTemperatureBreachMutation = {
...
`;
export const TemperatureBreachesDocument = gql`
