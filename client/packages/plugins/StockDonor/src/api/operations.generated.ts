 ...
 * })
 */
export const mockRequisitionCountsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<RequisitionCountsQueryVariables>,
    GraphQLContext<RequisitionCountsQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockOutboundShipmentCountsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<OutboundShipmentCountsQueryVariables>,
    GraphQLContext<OutboundShipmentCountsQuery>,
    any
  >
) =>
  graphql.query<
    OutboundShipmentCountsQuery,
    OutboundShipmentCountsQueryVariables
  >('outboundShipmentCounts', resolver);
 ...
 * })
 */
export const mockInboundShipmentCountsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<InboundShipmentCountsQueryVariables>,
    GraphQLContext<InboundShipmentCountsQuery>,
    any
  >
) =>
  graphql.query<
    InboundShipmentCountsQuery,
    InboundShipmentCountsQueryVariables
  >('inboundShipmentCounts', resolver);
