...
export type StocktakeFragment = {
  ...
  description?: string | null;
  isLocked: boolean;
  user: { __typename: 'UserNode'; username: string; email?: string | null };
  lines: {
...
export type SnapshotCountCurrentCountMismatchErrorFragment = {
  ...
  lines: {
    __typename: 'StocktakeLineConnector';
    nodes: Array<{ __typename: 'StocktakeLineNode'; id: string }>;
  };
};
 ...
 * })
 */
export const mockStocktakeByNumberQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<StocktakeByNumberQueryVariables>,
    GraphQLContext<StocktakeByNumberQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockUpsertStocktakeLinesMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpsertStocktakeLinesMutationVariables>,
    GraphQLContext<UpsertStocktakeLinesMutation>,
    any
  >
) =>
  graphql.mutation<
    UpsertStocktakeLinesMutation,
    UpsertStocktakeLinesMutationVariables
  >('upsertStocktakeLines', resolver);
