...
export type OutboundByNumberQuery = {
  __typename: 'Queries';
  invoiceByNumber:
    | {
        __typename: 'InvoiceNode';
...
export type UpdateOutboundShipmentNameMutation = {
  __typename: 'Mutations';
...
export type AddToOutboundShipmentFromMasterListMutation = {
  __typename: 'Mutations';
  addToOutboundShipmentFromMasterList:
    | {
        ...
        error:
          | { __typename: 'CannotEditInvoice'; description: string }
          | { __typename: 'MasterListNotFoundForThisName'; description: string }
          | { __typename: 'RecordNotFound'; description: string };
      }
 ...
 * })
 */
export const mockOutboundByNumberQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<OutboundByNumberQueryVariables>,
    GraphQLContext<OutboundByNumberQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockUpdateOutboundShipmentNameMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateOutboundShipmentNameMutationVariables>,
    GraphQLContext<UpdateOutboundShipmentNameMutation>,
    any
  >
) =>
  graphql.mutation<
    UpdateOutboundShipmentNameMutation,
    UpdateOutboundShipmentNameMutationVariables
  >('updateOutboundShipmentName', resolver);
 ...
 * })
 */
export const mockAddToOutboundShipmentFromMasterListMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<AddToOutboundShipmentFromMasterListMutationVariables>,
    GraphQLContext<AddToOutboundShipmentFromMasterListMutation>,
    any
  >
) =>
  graphql.mutation<
    AddToOutboundShipmentFromMasterListMutation,
    AddToOutboundShipmentFromMasterListMutationVariables
  >('addToOutboundShipmentFromMasterList', resolver);
