...
export const Toolbar: FC<{
  ...
  const onDelete = useReturns.lines.deleteSelected();
  const { onAllocate } = useReturns.lines.allocateSelected();
  const { id, otherParty, theirReference, update, requisition } =
    useReturns.document.fields([
      'id',
      'otherParty',
      'theirReference',
      'requisition',
  ...
  const isDisabled = useReturns.utils.isDisabled();

  const selectedIds: string[] = useReturns.utils.selectedIds();
