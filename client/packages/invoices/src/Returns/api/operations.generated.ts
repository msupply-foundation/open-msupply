...
export type InsertSupplierReturnMutation = {
  ...
  insertSupplierReturn:
    ...
    | { __typename: 'InvoiceNode'; id: string; invoiceNumber: number, originalShipment?: { __typename: 'InvoiceNode', id: string } | null };
};
...
export type UpdateSupplierReturnLinesMutation = {
  __typename: 'Mutations';
  updateSupplierReturnLines: { __typename: 'InvoiceNode'; id: string, originalShipment?: { __typename: 'InvoiceNode', id: string } | null };
};
...
export type UpdateCustomerReturnLinesMutation = {
  __typename: 'Mutations';
  updateCustomerReturnLines: { __typename: 'InvoiceNode'; id: string, originalShipment?: { __typename: 'InvoiceNode', id: string } | null };
};
