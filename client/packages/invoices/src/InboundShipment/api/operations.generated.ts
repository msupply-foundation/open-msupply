...
export type InboundRowFragment = { __typename: 'InvoiceNode', comment?: string | null, createdDatetime: string, deliveredDatetime?: string | null, id: string, invoiceNumber: number, otherPartyName: string, status: Types.InvoiceNodeStatus, colour?: string | null, theirReference?: string | null, taxPercentage?: number | null, onHold: boolean, currencyRate: number, pricing: { __typename: 'PricingNode', totalAfterTax: number, taxPercentage?: number | null, foreignCurrencyTotalAfterTax?: number | null }, linkedShipment?: { __typename: 'InvoiceNode', id: string } | null, currency: { __typename: 'CurrencyNode', id: string, code: string, rate: number, isHomeCurrency: boolean } };
