 ...
 * })
 */
export const mockInboundByNumberQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<InboundByNumberQueryVariables>,
    GraphQLContext<InboundByNumberQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockDeleteInboundShipmentLinesMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<DeleteInboundShipmentLinesMutationVariables>,
    GraphQLContext<DeleteInboundShipmentLinesMutation>,
    any
  >
) =>
  graphql.mutation<
  ...
  >('deleteInboundShipmentLines', resolver);
 ...
 * })
 */
export const mockAddToInboundShipmentFromMasterListMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<AddToInboundShipmentFromMasterListMutationVariables>,
    GraphQLContext<AddToInboundShipmentFromMasterListMutation>,
    any
  >
) =>
  graphql.mutation<
    AddToInboundShipmentFromMasterListMutation,
    AddToInboundShipmentFromMasterListMutationVariables
  >('addToInboundShipmentFromMasterList', resolver);
