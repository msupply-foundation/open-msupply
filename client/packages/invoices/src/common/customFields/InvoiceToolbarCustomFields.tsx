 ...
 * immediately on change like every other toolbar field. Prominent fields
 * appear only here, not in the Custom fields tab, to avoid duplication.
 * Renders nothing when the scope has no prominent fields.
 *
 ...
 * Custom fields tab, which buffers a draft behind an explicit Save. Revisit (e.g.
...
export const InvoiceToolbarCustomFields = ({
  ...
  // Gate on the same mutate permission as the Custom fields tab, so the property
