...
export type DocumentFragment = { __typename: 'DocumentNode', id: string, name: string, type: string, data: any, documentRegistry?: { __typename: 'DocumentRegistryNode', uiSchemaType: string, documentType: string, context: Types.DocumentRegistryNodeContext, jsonSchema: any, uiSchema: any } | null };
...
export type DocumentByNameQuery = { __typename: 'FullQuery', document?: { __typename: 'DocumentNode', id: string, name: string, type: string, data: any, documentRegistry?: { __typename: 'DocumentRegistryNode', uiSchemaType: string, documentType: string, context: Types.DocumentRegistryNodeContext, jsonSchema: any, uiSchema: any } | null } | null };
