...
public class ExtendedWebViewClient extends BridgeWebViewClient {
    ...
    String generatePluginScript() {
        ...
        List<String> pluginNames =  Arrays.asList("NativeApi","Keyboard", "WebView","BarcodeScanner","Preferences", "KeepAwake", "App", "Printer", "Camera", "Geolocation", "Filesystem", "FileOpener", "Device", "ScreenOrientation");
