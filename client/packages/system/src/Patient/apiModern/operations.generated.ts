...
export type InsuranceFragment = {
  ...
  policyType: Types.InsurancePolicyNodeType;
  policyNumber: string;
...
export type InsurancePoliciesQueryVariables = Types.Exact<{
  ...
  sort?: Types.InputMaybe<
    Array<Types.InsuranceSortInput> | Types.InsuranceSortInput
  >;
}>;
...
export type InsertInsuranceMutation = {
  __typename: 'Mutations';
  insertInsurance: { __typename: 'IdResponse'; id: string };
};
...
export type UpdateInsuranceMutation = {
  __typename: 'Mutations';
  updateInsurance: { __typename: 'IdResponse'; id: string };
};

export type InsuranceProvidersFragment = {
  __typename: 'InsuranceProvidersNode';
  id: string;
  providerName: string;
  isActive: boolean;
  prescriptionValidityDays?: number | null;
};
...
export type InsuranceProvidersQuery = {
  __typename: 'Queries';
  insuranceProviders: {
