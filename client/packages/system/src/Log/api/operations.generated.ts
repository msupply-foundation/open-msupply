...
export type ActivityLogRowFragment = {
  ...
  storeId?: string | null;
  type: Types.ActivityLogNodeType;
 ...
 * })
 */
export const mockActivityLogsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ActivityLogsQueryVariables>,
    GraphQLContext<ActivityLogsQuery>,
    any
  >
) =>
