...
export type InsertImmunisationProgramMutation = {
  ...
  centralServer: {
    ...
    program: {
      ...
      insertImmunisationProgram:
        ...
        | { __typename: 'ProgramNode'; id: string; name: string };
    };
  };
};
    ...
    vaccineCourse: {
      ...
      insertVaccineCourse:
        | {
            ...
            error: { __typename: 'RecordAlreadyExist'; description: string };
          }
        | {
            __typename: 'VaccineCourseNode';
            id: string;
...
export type UpdateImmunisationProgramMutation = {
  __typename: 'Mutations';
  centralServer: {
    __typename: 'CentralServerMutationNode';
    program: {
...
export function getSdk(
  ...
  return {
    ...
    insertImmunisationProgram(
      variables?: InsertImmunisationProgramMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<InsertImmunisationProgramMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<InsertImmunisationProgramMutation>(
            InsertImmunisationProgramDocument,
            variables,
 ...
 * })
 */
export const mockProgramsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ProgramsQueryVariables>,
    GraphQLContext<ProgramsQuery>,
    any
  >
) => graphql.query<ProgramsQuery, ProgramsQueryVariables>('programs', resolver);
 ...
 * })
 */
export const mockInsertImmunisationProgramMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertImmunisationProgramMutationVariables>,
    GraphQLContext<InsertImmunisationProgramMutation>,
    any
  >
) =>
  graphql.mutation<
    InsertImmunisationProgramMutation,
    InsertImmunisationProgramMutationVariables
  >('insertImmunisationProgram', resolver);
