 ...
 * })
 */
export const mockVaccineCoursesQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<VaccineCoursesQueryVariables>,
    GraphQLContext<VaccineCoursesQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockInsertVaccineCourseMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertVaccineCourseMutationVariables>,
    GraphQLContext<InsertVaccineCourseMutation>,
    any
  >
) =>
  graphql.mutation<
    InsertVaccineCourseMutation,
    InsertVaccineCourseMutationVariables
  >('insertVaccineCourse', resolver);
