...
export type AssetClassesQueryVariables = Types.Exact<{
  sort?: Types.InputMaybe<
    Array<Types.AssetClassSortInput> | Types.AssetClassSortInput
  >;
}>;
...
export type AssetTypesQueryVariables = Types.Exact<{
  sort?: Types.InputMaybe<
    Array<Types.AssetTypeSortInput> | Types.AssetTypeSortInput
  >;
...
export type AssetCategoriesQueryVariables = Types.Exact<{
  sort?: Types.InputMaybe<
    Array<Types.AssetCategorySortInput> | Types.AssetCategorySortInput
  >;
...
export type AssetPropertiesQuery = {
  __typename: 'Queries';
  assetProperties: {
...
export type AssetLogReasonsQueryVariables = Types.Exact<{
  ...
  sort?: Types.InputMaybe<
    Array<Types.AssetLogReasonSortInput> | Types.AssetLogReasonSortInput
  >;
  storeId: Types.Scalars['String']['input'];
}>;

export type AssetLogReasonsQuery = {
  __typename: 'Queries';
  assetLogReasons: {
...
export type InsertAssetLogReasonMutation = {
  __typename: 'Mutations';
  centralServer: {
    __typename: 'CentralServerMutationNode';
    logReason: {
      ...
      insertAssetLogReason:
        | { __typename: 'AssetLogReasonNode'; id: string; reason: string }
        | {
...
export type DeleteLogReasonMutation = {
  __typename: 'Mutations';
  centralServer: {
    __typename: 'CentralServerMutationNode';
    logReason: {
