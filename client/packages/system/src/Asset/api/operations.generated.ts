...
export type AssetCatalogueItemFragment = {
  ...
  model: string;
  subCatalogue: string;
  assetClass?: { __typename: 'AssetClassNode'; name: string } | null;
...
export type AssetCatalogueItemByIdQuery = {
  __typename: 'Queries';
  assetCatalogueItems: {
    __typename: 'AssetCatalogueItemConnector';
    totalCount: number;
...
export type AssetClassesQuery = {
  __typename: 'Queries';
  assetClasses: {
    __typename: 'AssetClassConnector';
    totalCount: number;
    nodes: Array<{ __typename: 'AssetClassNode'; id: string; name: string }>;
  };
};
  ...
  centralServer: {
    ...
    assetCatalogue: {
      ...
      insertAssetCatalogueItem:
        | { __typename: 'AssetCatalogueItemNode'; id: string }
        | {
            ...
            error:
              ...
              | {
                  ...
                  fields: Array<Types.UniqueCombinationKey>;
                  description: string;
                }
              | {
 ...
 * })
 */
export const mockAssetCatalogueItemsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<AssetCatalogueItemsQueryVariables>,
    GraphQLContext<AssetCatalogueItemsQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockAssetCatalogueItemByIdQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<AssetCatalogueItemByIdQueryVariables>,
    GraphQLContext<AssetCatalogueItemByIdQuery>,
    any
  >
) =>
  graphql.query<
    AssetCatalogueItemByIdQuery,
    AssetCatalogueItemByIdQueryVariables
  >('assetCatalogueItemById', resolver);
 ...
 * })
 */
export const mockAssetClassesQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<AssetClassesQueryVariables>,
    GraphQLContext<AssetClassesQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockAssetTypesQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<AssetTypesQueryVariables>,
    GraphQLContext<AssetTypesQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockAssetCategoriesQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<AssetCategoriesQueryVariables>,
    GraphQLContext<AssetCategoriesQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockInsertAssetCatalogueItemMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertAssetCatalogueItemMutationVariables>,
    GraphQLContext<InsertAssetCatalogueItemMutation>,
    any
  >
) =>
  graphql.mutation<
    InsertAssetCatalogueItemMutation,
    InsertAssetCatalogueItemMutationVariables
  >('insertAssetCatalogueItem', resolver);
 ...
 * })
 */
export const mockDeleteAssetCatalogueItemMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<DeleteAssetCatalogueItemMutationVariables>,
    GraphQLContext<DeleteAssetCatalogueItemMutation>,
    any
  >
) =>
  graphql.mutation<
    DeleteAssetCatalogueItemMutation,
    DeleteAssetCatalogueItemMutationVariables
  >('deleteAssetCatalogueItem', resolver);
