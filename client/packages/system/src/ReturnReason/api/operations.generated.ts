...
export type ReturnReasonFragment = {
...
export type ReturnReasonsQueryVariables = Types.Exact<{
  sort?: Types.InputMaybe<
    Array<Types.ReturnReasonSortInput> | Types.ReturnReasonSortInput
  >;
  filter?: Types.InputMaybe<Types.ReturnReasonFilterInput>;
}>;

export type ReturnReasonsQuery = {
  __typename: 'Queries';
  returnReasons: {
...
export function getSdk(
  ...
  return {
    returnReasons(
      variables?: ReturnReasonsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ReturnReasonsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<ReturnReasonsQuery>(ReturnReasonsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'returnReasons',
