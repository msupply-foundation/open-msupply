...
export type SyncSettingsFragment = { __typename: 'SyncSettingsNode', centralServerSiteId: number, intervalSec: number, siteHardwareId: string, siteId: number, url: string, username: string };
...
export type ServerSettingsQuery = { __typename: 'FullQuery', serverSettings: { __typename: 'ServerSettingsNode', status: Types.ServerStatus, syncSettingsDb?: { __typename: 'SyncSettingsNode', centralServerSiteId: number, intervalSec: number, siteHardwareId: string, siteId: number, url: string, username: string } | null, syncSettings?: { __typename: 'SyncSettingsNode', centralServerSiteId: number, intervalSec: number, siteHardwareId: string, siteId: number, url: string, username: string } | null } };
