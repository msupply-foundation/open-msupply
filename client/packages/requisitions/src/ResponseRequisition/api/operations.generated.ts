...
export type ResponseLineFragment = {
  ...
  linkedRequisitionLine?: {
    __typename: 'RequisitionLineNode';
    itemStats: { __typename: 'ItemStatsNode'; availableStockOnHand: number };
  } | null;
};
 ...
 * })
 */
export const mockUpdateResponseMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateResponseMutationVariables>,
    GraphQLContext<UpdateResponseMutation>,
    any
  >
) =>
 ...
 * })
 */
export const mockResponseByNumberQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ResponseByNumberQueryVariables>,
    GraphQLContext<ResponseByNumberQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockResponsesQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ResponsesQueryVariables>,
    GraphQLContext<ResponsesQuery>,
    any
  >
) =>
  graphql.query<ResponsesQuery, ResponsesQueryVariables>('responses', resolver);
 ...
 * })
 */
export const mockUpdateResponseLineMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateResponseLineMutationVariables>,
    GraphQLContext<UpdateResponseLineMutation>,
    any
  >
) =>
  graphql.mutation<
    UpdateResponseLineMutation,
    UpdateResponseLineMutationVariables
  >('updateResponseLine', resolver);
 ...
 * })
 */
export const mockCreateOutboundFromResponseMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<CreateOutboundFromResponseMutationVariables>,
    GraphQLContext<CreateOutboundFromResponseMutation>,
    any
  >
) =>
  graphql.mutation<
    CreateOutboundFromResponseMutation,
    CreateOutboundFromResponseMutationVariables
  >('createOutboundFromResponse', resolver);
 ...
 * })
 */
export const mockSupplyRequestedQuantityMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<SupplyRequestedQuantityMutationVariables>,
    GraphQLContext<SupplyRequestedQuantityMutation>,
    any
  >
) =>
  graphql.mutation<
    SupplyRequestedQuantityMutation,
    SupplyRequestedQuantityMutationVariables
  >('supplyRequestedQuantity', resolver);
 ...
 * })
 */
export const mockResponseRequisitionStatsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ResponseRequisitionStatsQueryVariables>,
    GraphQLContext<ResponseRequisitionStatsQuery>,
    any
  >
) =>
  graphql.query<
    ResponseRequisitionStatsQuery,
    ResponseRequisitionStatsQueryVariables
  >('responseRequisitionStats', resolver);
