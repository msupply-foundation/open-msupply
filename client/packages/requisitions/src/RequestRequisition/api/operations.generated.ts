...
export type InsertProgramRequestMutation = { __typename: 'Mutations', insertProgramRequestRequisition: { __typename: 'RequisitionNode', id: string, requisitionNumber: number } };
...
export const ProgramSettingsDocument = gql`
  ...
  programRequistitionSettings(storeId: $storeId) {
    ...ProgramSettings
  }
}
 ...
 *   return res(
 *     ctx.data({ programRequistitionSettings })
 *   )
 * })
 */
