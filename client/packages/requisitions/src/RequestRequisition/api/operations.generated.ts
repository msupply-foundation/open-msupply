...
export type ProgramSettingsFragment = {
  __typename: 'ProgramRequisitionSettingNode';
  programId: string;
  label: string;
  suppliers: Array<{ __typename: 'NameNode'; id: string; label: string }>;
  orderTypes: Array<{
...
export type ProgramSettingsQuery = {
  __typename: 'Queries';
  programRequisitionSettings: Array<{
    __typename: 'ProgramRequisitionSettingNode';
    programId: string;
    label: string;
    suppliers: Array<{ __typename: 'NameNode'; id: string; label: string }>;
 ...
 * })
 */
export const mockRequestByNumberQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<RequestByNumberQueryVariables>,
    GraphQLContext<RequestByNumberQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockRequisitionLineChartQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<RequisitionLineChartQueryVariables>,
    GraphQLContext<RequisitionLineChartQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockRequestsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<RequestsQueryVariables>,
    GraphQLContext<RequestsQuery>,
    any
  >
) => graphql.query<RequestsQuery, RequestsQueryVariables>('requests', resolver);
 ...
 * })
 */
export const mockInsertRequestLineMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertRequestLineMutationVariables>,
    GraphQLContext<InsertRequestLineMutation>,
    any
  >
) =>
  graphql.mutation<
    InsertRequestLineMutation,
    InsertRequestLineMutationVariables
  >('insertRequestLine', resolver);
 ...
 * })
 */
export const mockUpdateRequestLineMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateRequestLineMutationVariables>,
    GraphQLContext<UpdateRequestLineMutation>,
    any
  >
) =>
  graphql.mutation<
 ...
 * })
 */
export const mockAddFromMasterListMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<AddFromMasterListMutationVariables>,
    GraphQLContext<AddFromMasterListMutation>,
    any
  >
) =>
  graphql.mutation<
    AddFromMasterListMutation,
    AddFromMasterListMutationVariables
  >('addFromMasterList', resolver);
 ...
 * })
 */
export const mockDeleteRequestLinesMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<DeleteRequestLinesMutationVariables>,
    GraphQLContext<DeleteRequestLinesMutation>,
    any
  >
) =>
  graphql.mutation<
    DeleteRequestLinesMutation,
    DeleteRequestLinesMutationVariables
  >('deleteRequestLines', resolver);
 ...
 * })
 */
export const mockUseSuggestedQuantityMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UseSuggestedQuantityMutationVariables>,
    GraphQLContext<UseSuggestedQuantityMutation>,
    any
  >
) =>
  graphql.mutation<
    UseSuggestedQuantityMutation,
    UseSuggestedQuantityMutationVariables
  >('useSuggestedQuantity', resolver);
 ...
 * })
 */
export const mockInsertRequestMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertRequestMutationVariables>,
    GraphQLContext<InsertRequestMutation>,
    any
  >
) =>
 ...
 * })
 */
export const mockInsertProgramRequestMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertProgramRequestMutationVariables>,
    GraphQLContext<InsertProgramRequestMutation>,
    any
  >
) =>
  graphql.mutation<
    InsertProgramRequestMutation,
    InsertProgramRequestMutationVariables
  >('insertProgramRequest', resolver);
 ...
 * })
 */
export const mockUpdateRequestMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateRequestMutationVariables>,
    GraphQLContext<UpdateRequestMutation>,
    any
  >
) =>
 ...
 * })
 */
export const mockDeleteRequestMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<DeleteRequestMutationVariables>,
    GraphQLContext<DeleteRequestMutation>,
    any
  >
) =>
 ...
 * })
 */
export const mockProgramSettingsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ProgramSettingsQueryVariables>,
    GraphQLContext<ProgramSettingsQuery>,
    any
  >
) =>
