...
export type RequestLineChartDataFragment = { __typename: 'ItemChartDataNode', consumptionHistory: { __typename: 'ConsumptionHistoryConnector', nodes: Array<{ __typename: 'ConsumptionHistoryNode', amc: number, consumption: number, isHistoric: boolean, date: string }> }, suggestedQuantityCalculation: { __typename: 'SuggestedQuantityCalculationNode', stockOnHand: number, suggested: number, minimumStockOnHand: number, maximumStockOnHand: number, averageMonthlyConsumption: number }, stockEvolution: { __typename: 'StockEvolutionConnector', nodes: Array<{ __typename: 'StockEvolutionNode', stockOnHand: number, isHistoric: boolean, max: number, min: number, date: string }> } };

export type RequestLineFragment = { __typename: 'RequisitionLineNode', id: string, itemId: string, requestedQuantity: number, suggestedQuantity: number, comment?: string | null, itemStats: { __typename: 'ItemStatsNode', availableStockOnHand: number, availableMonthsOfStockOnHand: number, averageMonthlyConsumption: number }, item: { __typename: 'ItemNode', id: string, name: string, code: string, unitName?: string | null, stats: { __typename: 'ItemStatsNode', averageMonthlyConsumption: number, availableStockOnHand: number, availableMonthsOfStockOnHand: number } }, chartData: { __typename: 'ItemChartDataNode', consumptionHistory: { __typename: 'ConsumptionHistoryConnector', nodes: Array<{ __typename: 'ConsumptionHistoryNode', amc: number, consumption: number, isHistoric: boolean, date: string }> }, suggestedQuantityCalculation: { __typename: 'SuggestedQuantityCalculationNode', stockOnHand: number, suggested: number, minimumStockOnHand: number, maximumStockOnHand: number, averageMonthlyConsumption: number }, stockEvolution: { __typename: 'StockEvolutionConnector', nodes: Array<{ __typename: 'StockEvolutionNode', stockOnHand: number, isHistoric: boolean, max: number, min: number, date: string }> } } };

export type RequestFragment = { __typename: 'RequisitionNode', id: string, type: Types.RequisitionNodeType, status: Types.RequisitionNodeStatus, createdDatetime: string, sentDatetime?: string | null, finalisedDatetime?: string | null, requisitionNumber: number, colour?: string | null, theirReference?: string | null, comment?: string | null, otherPartyName: string, otherPartyId: string, maxMonthsOfStock: number, minMonthsOfStock: number, user?: { __typename: 'UserNode', username: string, email?: string | null } | null, lines: { __typename: 'RequisitionLineConnector', totalCount: number, nodes: Array<{ __typename: 'RequisitionLineNode', id: string, itemId: string, requestedQuantity: number, suggestedQuantity: number, comment?: string | null, itemStats: { __typename: 'ItemStatsNode', availableStockOnHand: number, availableMonthsOfStockOnHand: number, averageMonthlyConsumption: number }, item: { __typename: 'ItemNode', id: string, name: string, code: string, unitName?: string | null, stats: { __typename: 'ItemStatsNode', averageMonthlyConsumption: number, availableStockOnHand: number, availableMonthsOfStockOnHand: number } }, chartData: { __typename: 'ItemChartDataNode', consumptionHistory: { __typename: 'ConsumptionHistoryConnector', nodes: Array<{ __typename: 'ConsumptionHistoryNode', amc: number, consumption: number, isHistoric: boolean, date: string }> }, suggestedQuantityCalculation: { __typename: 'SuggestedQuantityCalculationNode', stockOnHand: number, suggested: number, minimumStockOnHand: number, maximumStockOnHand: number, averageMonthlyConsumption: number }, stockEvolution: { __typename: 'StockEvolutionConnector', nodes: Array<{ __typename: 'StockEvolutionNode', stockOnHand: number, isHistoric: boolean, max: number, min: number, date: string }> } } }> }, shipments: { __typename: 'InvoiceConnector', totalCount: number, nodes: Array<{ __typename: 'InvoiceNode', id: string, invoiceNumber: number, createdDatetime: string, user?: { __typename: 'UserNode', username: string } | null }> }, otherParty: { __typename: 'NameNode', id: string, code: string, isCustomer: boolean, isSupplier: boolean, name: string, store?: { __typename: 'StoreNode', id: string, code: string } | null } };
