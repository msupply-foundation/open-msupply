...
export type DocumentRegistryWithChildrenFragment = {
  __typename: 'DocumentRegistryNode';
  id: string;
  documentType: string;
  context: Types.DocumentRegistryNodeContext;
...
export type DocumentRegistriesWithChildrenQuery = {
  __typename: 'Queries';
  documentRegistries: {
    __typename: 'DocumentRegistryConnector';
    totalCount: number;
...
export type ProgramEnrolmentByIdQuery = {
  __typename: 'Queries';
  programEnrolments: {
    __typename: 'ProgramEnrolmentConnector';
    totalCount: number;
...
export const DocumentRegistriesWithChildrenDocument = gql`
  query documentRegistriesWithChildren(
    $filter: DocumentRegistryFilterInput
    $sort: DocumentRegistrySortInput
  ) {
...
export function getSdk(
  ...
  return {
    ...
    documentRegistriesWithChildren(
      variables?: DocumentRegistriesWithChildrenQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DocumentRegistriesWithChildrenQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DocumentRegistriesWithChildrenQuery>(
            DocumentRegistriesWithChildrenDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'documentRegistriesWithChildren',
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<EncountersWithDocumentQuery>(
            EncountersWithDocumentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'encountersWithDocument',
    ...
    encounterById(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<EncounterByIdQuery>(EncounterByIdDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'encounterById',
    ...
    programEnrolmentById(
      variables: ProgramEnrolmentByIdQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<ProgramEnrolmentByIdQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<ProgramEnrolmentByIdQuery>(
            ProgramEnrolmentByIdDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'programEnrolmentById',
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<InsertProgramEnrolmentMutation>(
            InsertProgramEnrolmentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'insertProgramEnrolment',
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<UpdateProgramEnrolmentMutation>(
            UpdateProgramEnrolmentDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'updateProgramEnrolment',
    ...
    clinicians(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<CliniciansQuery>(CliniciansDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'clinicians',
 ...
 * })
 */
export const mockDocumentByNameQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<DocumentByNameQueryVariables>,
    GraphQLContext<DocumentByNameQuery>,
    any
  >
) =>
...
export const mockDocumentsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<DocumentsQueryVariables>,
    GraphQLContext<DocumentsQuery>,
    any
  >
) =>
  graphql.query<DocumentsQuery, DocumentsQueryVariables>('documents', resolver);
 ...
 * })
 */
export const mockDocumentRegistriesWithChildrenQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<DocumentRegistriesWithChildrenQueryVariables>,
    GraphQLContext<DocumentRegistriesWithChildrenQuery>,
    any
  >
) =>
  graphql.query<
    DocumentRegistriesWithChildrenQuery,
    DocumentRegistriesWithChildrenQueryVariables
  >('documentRegistriesWithChildren', resolver);
 ...
 * })
 */
export const mockAllocateProgramNumberMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<AllocateProgramNumberMutationVariables>,
    GraphQLContext<AllocateProgramNumberMutation>,
    any
  >
) =>
  graphql.mutation<
    AllocateProgramNumberMutation,
    AllocateProgramNumberMutationVariables
  >('allocateProgramNumber', resolver);
 ...
 * })
 */
export const mockEncounterFieldsQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<EncounterFieldsQueryVariables>,
    GraphQLContext<EncounterFieldsQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockEncountersWithDocumentQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<EncountersWithDocumentQueryVariables>,
    GraphQLContext<EncountersWithDocumentQuery>,
    any
  >
) =>
  graphql.query<
    EncountersWithDocumentQuery,
    EncountersWithDocumentQueryVariables
  >('encountersWithDocument', resolver);
 ...
 * })
 */
export const mockEncounterByIdQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<EncounterByIdQueryVariables>,
    GraphQLContext<EncounterByIdQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockInsertEncounterMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertEncounterMutationVariables>,
    GraphQLContext<InsertEncounterMutation>,
    any
  >
) =>
 ...
 * })
 */
export const mockUpdateEncounterMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateEncounterMutationVariables>,
    GraphQLContext<UpdateEncounterMutation>,
    any
  >
) =>
 ...
 * })
 */
export const mockProgramEnrolmentByIdQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<ProgramEnrolmentByIdQueryVariables>,
    GraphQLContext<ProgramEnrolmentByIdQuery>,
    any
  >
) =>
 ...
 * })
 */
export const mockInsertProgramEnrolmentMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<InsertProgramEnrolmentMutationVariables>,
    GraphQLContext<InsertProgramEnrolmentMutation>,
    any
  >
) =>
  graphql.mutation<
    InsertProgramEnrolmentMutation,
    InsertProgramEnrolmentMutationVariables
  >('insertProgramEnrolment', resolver);
 ...
 * })
 */
export const mockUpdateProgramEnrolmentMutation = (
  resolver: ResponseResolver<
    GraphQLRequest<UpdateProgramEnrolmentMutationVariables>,
    GraphQLContext<UpdateProgramEnrolmentMutation>,
    any
  >
) =>
  graphql.mutation<
    UpdateProgramEnrolmentMutation,
    UpdateProgramEnrolmentMutationVariables
  >('updateProgramEnrolment', resolver);
 ...
 * })
 */
export const mockCliniciansQuery = (
  resolver: ResponseResolver<
    GraphQLRequest<CliniciansQueryVariables>,
    GraphQLContext<CliniciansQuery>,
    any
  >
) =>
