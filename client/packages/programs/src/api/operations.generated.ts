...
export type ContactTraceRowFragment = { __typename: 'ContactTraceNode', contactTraceId?: string | null, datetime: string, documentId: string, id: string, firstName?: string | null, lastName?: string | null, gender?: Types.GenderType | null, dateOfBirth?: string | null, age?: number | null, patientId: string, document: { __typename: 'DocumentNode', name: string, type: string, id: string }, patient: { __typename: 'NameNode', id: string, name: string, firstName?: string | null, lastName?: string | null }, contactPatient?: { __typename: 'NameNode', id: string, name: string } | null, program: { __typename: 'ProgramNode', id: string, name: string } };
...
export type ContactTracesQuery = { __typename: 'Queries', contactTraces: { __typename: 'ContactTraceConnector', totalCount: number, nodes: Array<{ __typename: 'ContactTraceNode', contactTraceId?: string | null, datetime: string, documentId: string, id: string, firstName?: string | null, lastName?: string | null, gender?: Types.GenderType | null, dateOfBirth?: string | null, age?: number | null, patientId: string, document: { __typename: 'DocumentNode', name: string, type: string, id: string }, patient: { __typename: 'NameNode', id: string, name: string, firstName?: string | null, lastName?: string | null }, contactPatient?: { __typename: 'NameNode', id: string, name: string } | null, program: { __typename: 'ProgramNode', id: string, name: string } }> } };
